...
package io.grpc.examples.routeguide.utils;
...
public class RouteGuideUtil {
  ...
  public static URL getDefaultFeaturesFile() {
    return Thread.currentThread().getContextClassLoader().getResource("io/grpc/examples/routeguide/route_guide_db.json");
  }
